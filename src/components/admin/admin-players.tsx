...
export function AdminPlayer({ id }: { id: string }) {
  ...
  return <div className="stack-lg admin-operations"><Link className="text-link" href="/admin/players">← Players</Link><Intro title={player?.name ?? "Player detail"} description="Identity, access and server-confirmed wallet activity." />
