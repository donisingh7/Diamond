export const errorCodes = [
  ...
  "PLAYER_NOT_FOUND", "LOGIN_ID_TAKEN", "IDENTIFIER_TAKEN",
  "RESULT_TOO_EARLY", "RESULT_ALREADY_DECLARED", "RESULT_NOT_DECLARED",
  ...
  "PAYMENT_METHOD_NOT_FOUND", "PAYMENT_METHOD_INACTIVE",
  "DEPOSIT_REQUEST_NOT_FOUND", "DEPOSIT_NOT_PENDING", "DUPLICATE_UTR",
  "INVALID_IMAGE", "IMAGE_NOT_FOUND",
] as const;
...
const statusByCode: Record<ErrorCode, number> = {
  ...
  PLAYER_NOT_FOUND: 404, LOGIN_ID_TAKEN: 409, IDENTIFIER_TAKEN: 409,
  RESULT_TOO_EARLY: 422, RESULT_ALREADY_DECLARED: 409, RESULT_NOT_DECLARED: 422,
  ...
  PAYMENT_METHOD_NOT_FOUND: 404, PAYMENT_METHOD_INACTIVE: 422,
